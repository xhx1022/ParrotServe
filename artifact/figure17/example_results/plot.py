...
names = {
    "parrot": "Parrot",
    "parrot w/ paged": "Parrot 加上 PagedAttention",
    "vllm_lat": "基线 (vLLM, 延迟)",
    "vllm_thr": "基线 (vLLM, 吞吐量)",
}
...
ax2.set_xlabel("文件数量", fontsize=40)
ax2.set_ylabel("平均延迟 (秒)", fontsize=40)
...
ax.set_xlabel("文件数量", fontsize=50)
ax.set_ylabel("KV缓存大小(GB)", fontsize=50)
ax.set_xticks([_ for _ in x])
